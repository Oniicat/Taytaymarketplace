...
// Content keys to fetch from the database
...
<head>
  ...
  <link rel="stylesheet" href="MarketPlace(Seller).css">
...
function redirectToProductReviewSeller(productId) {
  // Redirect to Product_Review.php with the product ID as a query parameter
  window.location.href = `ProductReview(Seller).php?product_id=${encodeURIComponent(productId)}`;
}
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        productWidgets.forEach(widget => {
            widget.addEventListener('click', function() {
                ...
                window.location.href = 'ProductReview(Seller).php?product=' + encodeURIComponent(productTitle);
            });
        });
    });
